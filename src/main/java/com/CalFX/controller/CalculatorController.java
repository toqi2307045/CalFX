...
import com.CalFX.calculator.ExpressionBuffer;
...
public class CalculatorController {
    ...
    public CalculatorController(Navigator navigator, CalculationHistoryStore historyStore) {
    ...
    private void onEquals() {
        ...
        try {
            ...
            historyStore.insertAsync("Calculator", expression, result);
